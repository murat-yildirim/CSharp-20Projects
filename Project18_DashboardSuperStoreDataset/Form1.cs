...
namespace Project18_DashboardSuperStoreDataset
{
	public partial class Form1 : Form
	{
		...
		SqlConnection sqlConnection = new SqlConnection("Server=DESKTOP-363RU31\\SQLEXPRESS;initial catalog=Db17Project20;integrated security=true");

		private void Form1_Load(object sender, EventArgs e)
		{
			#region Widgets
			// TOPLAM ÜRÜN SAYISI LİSTELEME
			sqlConnection.Open();
			...
			//TÜRKİYEDEN YAPILAN SİPARİŞ SAYISI LİSTELEME
			sqlConnection.Open();
			...
			//TOPLAM SİPARİŞ ADEDİ LİSTELEME
			sqlConnection.Open();
