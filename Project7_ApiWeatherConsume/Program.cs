...
Console.WriteLine();
Console.WriteLine("1-Şehir Listesine Getirin");
...
if (number == "1")
{
	string url = "https://localhost:7239/api/Weathers";
...
if (number == "4")
{
	string url = "https://localhost:7239/api/Weathers?id=";
...
if (number == "6")
{
	string url = "https://localhost:7239/api/Weathers/GetByIdWeatherCity?id=";
	...
	using (HttpClient client = new HttpClient())
	{
		...
		Console.Write("Girmiş olduğunuz Id değerleri ait bilgiler");
		Console.WriteLine();
